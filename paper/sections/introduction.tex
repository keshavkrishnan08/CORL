...
would have found with rollouts. ACT~\citep{zhao2023} adopted validation-loss selection as a
working compromise, not a principled choice. SIMPLER~\citep{li2024} measured low correlation
between validation error and real success. NeME~\citep{tiezzi2025} built a learned
